...
const AfterMoney: React.FC = () => {
  ...
  // Stats 3D
  const statsRotateX = useTransform(scrollYProgress, [0.3, 0.5, 0.7], [20, 0, -20]);
  const statsScale = useTransform(scrollYProgress, [0.3, 0.5, 0.7], [0.9, 1, 0.9]);
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex justify-between items-center px-6 md:px-12 pb-12">
        <span className="text-neutral-600 text-xs tracking-[0.3em] font-mono">[ 05 / 09 ]</span>
        <span className="text-neutral-600 text-xs tracking-[0.3em] font-mono">ПРЕИМУЩЕСТВА</span>
      </div>
        ...
        <div className="text-center">
          <div className="overflow-hidden mb-2">
            <motion.div style={{ y: y1, rotate: rotate1 }}>
              <span className="block text-[18vw] md:text-[14vw] lg:text-[12vw] font-black tracking-tighter text-[#FF3B30] leading-[0.85]">
                Быстро.
              </span>
            </motion.div>
          </div>
          ...
          <div className="overflow-hidden mb-2">
            <motion.div style={{ y: y2, rotate: rotate2 }}>
              <span className="block text-[18vw] md:text-[14vw] lg:text-[12vw] font-black tracking-tighter text-white leading-[0.85]">
                Качественно.
              </span>
            </motion.div>
          </div>
          ...
          <div className="overflow-hidden">
            <motion.div style={{ y: y3, rotate: rotate3 }}>
              <span className="block text-[18vw] md:text-[14vw] lg:text-[12vw] font-black tracking-tighter text-neutral-700 leading-[0.85]">
                Надёжно.
              </span>
            </motion.div>
          </div>
        ...
        <div className="grid grid-cols-3">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className={`relative group ${index !== 2 ? 'border-r border-white/10' : ''}`}
            ...
            >
              ...
              >
                ...
                {/* Value */}
                <motion.div 
                  className="text-5xl md:text-7xl lg:text-8xl font-black text-white mb-3 tracking-tight relative z-10"
